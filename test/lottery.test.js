...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.wukong = await MockBEP20.deployed();
        ...
        await this.wukong.transfer(bob, '2000', { from: minter });
        await this.wukong.transfer(alice, '2000', { from: minter });
        await this.wukong.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.wukong.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.wukong.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.wukong.balanceOf(this.lotteryProxyAddress)).toString(), '418');
