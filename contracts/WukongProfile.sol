...
// File: @wukongfinance/matrixswap-lib/contracts/token/BEP20/IBEP20.sol
...
// File: contracts/WukongProfile.sol
...
*/
contract WukongProfile is AccessControl, ERC721Holder {
    using Counters for Counters.Counter;
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;

    IBEP20 public wukongToken;
    ...
    uint256 public numberWukongToReactivate;
    uint256 public numberWukongToRegister;
    uint256 public numberWukongToUpdate;
    ...
    constructor(
        IBEP20 _wukongToken,
        uint256 _numberWukongToReactivate,
        uint256 _numberWukongToRegister,
        uint256 _numberWukongToUpdate
    ) public {
        wukongToken = _wukongToken;
        numberWukongToReactivate = _numberWukongToReactivate;
        numberWukongToRegister = _numberWukongToRegister;
        numberWukongToUpdate = _numberWukongToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends WUKONG to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer WUKONG tokens to this contract
        wukongToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberWukongToRegister
        );
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer WUKONG token to this address
        wukongToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberWukongToUpdate
        );
    ...
    /**
     * @dev Claim WUKONG to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        wukongToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of WUKONG to register
     * Callable only by owner admins.
     */
    function updateNumberWukong(
        uint256 newNumberWukongToReactivate,
        uint256 _newNumberWukongToRegister,
        uint256 _newNumberWukongToUpdate
    ) external onlyOwner {
        numberWukongToReactivate = newNumberWukongToReactivate;
        numberWukongToRegister = _newNumberWukongToRegister;
        numberWukongToUpdate = _newNumberWukongToUpdate;
    }
