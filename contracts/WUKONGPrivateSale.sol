...
contract WUKONGPrivateSale {
    ...
    uint256 public totalTokensToSell = 30000000 * 10**18;          // 30000000 WUKONG tokens for sell
    uint256 public wukongPerBnb = 10000 * 10**18;             // 1 BNB = 10000 WUKONG
